...
export const LuxuryHero = () => {
  ...
  const translations = {
    en: {
      ...
      subtitle: "Experience the fusion of nature's finest ingredients and scientific innovation. A ritual designed for those who demand perfection.",
      shopNow: "Shop Now",
    ...
    ar: {
      ...
      subtitle: "اختبر اندماج أفضل مكونات الطبيعة والابتكار العلمي. طقوس مصممة لأولئك الذين يطالبون بالكمال.",
      shopNow: "تسوق الآن",
  ...
  return <div className="relative h-screen w-full overflow-hidden bg-luxury-black">
      ...
      <button onClick={scrollToCollection} className="absolute bottom-10 left-1/2 -translate-x-1/2 text-soft-ivory/50 transition-colors duration-300 hover:text-gold-300 animate-fade-in-up opacity-0 [animation-delay:1s]">
        <div className="flex flex-col items-center gap-2">
          <span className="font-sans text-xs uppercase tracking-widest">{t.scroll}</span>
