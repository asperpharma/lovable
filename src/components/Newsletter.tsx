...
export const Newsletter = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (email) {
      toast.success(isArabic ? "مرحباً بك في آسبر بيوتي" : "Welcome to Asper Beauty", {
        description: isArabic ? "ستصلك آخر العروض الحصرية قريباً." : "You'll receive our exclusive updates soon.",
        position: "top-center"
      });
      setEmail("");
    }
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-gradient-to-b from-cream via-cream to-cream-dark relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
              ...
              <div className={`relative flex-1 transition-all duration-500 ${isFocused ? 'scale-[1.02]' : ''}`}>
                <input 
                  ...
                  placeholder={isArabic ? "أدخلي بريدك الإلكتروني" : "Enter your email"} 
