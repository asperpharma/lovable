              ...
              <div className="bg-gradient-to-br from-luxury-black to-gray-800 text-white p-5">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-white/60 mt-0.5">{userEmail}</p>
                  </div>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-white/10 pt-4">
                  <div>
                    ...
                    <p className="text-xl font-bold">{loyaltyData.points} pts</p>
                  </div>
          ...
          <div className="p-6">
            <div className="text-center mb-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {isAr ? "سجلي الدخول للوصول إلى حسابك" : "Sign in to access your account"}
              </p>
            </div>
            ...
            <p className="text-xs text-center text-muted-foreground mt-4">
              ...
              <Link to="/auth?mode=signup" className="text-gold-500 font-medium hover:underline">
