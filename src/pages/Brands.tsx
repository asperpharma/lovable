...
const FEATURED_BRANDS = [
  {
    id: 'vichy',
    name: 'Vichy',
    description: 'French pharmacy skincare powered by Volcanic Mineralizing Water',
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="text-center px-6 py-3 bg-white/10 backdrop-blur-sm rounded-xl">
                        <div className="font-display text-3xl text-gold">{brand.productCount}</div>
                        <div className="text-cream/60 text-sm">{isAr ? 'منتج' : 'Products'}</div>
                      </div>
                      <div className={`
                ...
                >
                  ...
                  `}>
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
                      ...
                      <ArrowRight className={`w-4 h-4 ${brand.iconColor} group-hover:translate-x-1 transition-transform`} />
                    </div>
                  </div>
                </Link>
              );
